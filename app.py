...
# Ajouter ici le code pour les cartes par année en veillant à l'indentation correcte

# ===================== AUTRES SECTIONS =====================

# Tous les autres blocs (analyse, download PDF, hazop, etc.) doivent suivre le même style d'indentation de 4 espaces
